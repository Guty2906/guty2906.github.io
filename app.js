// ====== PERSONALIZA AQUÍ ======
const CONFIG = {
  herName: "Sofía",               // <-- cámbialo
  yourName: "Carlos",             // <-- cámbialo
  sinceDate: "2023-11-24",        // <-- fecha desde la que cuentan (YYYY-MM-DD)
...
function setupMusic(){
  ...
  // 2) Si lo bloquean, primer toque en cualquier parte lo activa
